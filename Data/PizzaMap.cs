...
namespace BlazingPizza.Data
{
    public class PizzaMap: ClassMap<Pizza>
    {
         public PizzaMap()
        {
            ...
            HasMany(x => x.Toppings).Cascade.None().Not.LazyLoad(); // Assuming Toppings is a collection of PizzaTopping
            References(x => x.Order).Column(nameof(Pizza.OrderId)).Nullable().Not.LazyLoad();
